...
if __name__ == "__main__":
    ...
    # Get fragment retsrictions #
    fragment_restrict=None

    # Get binding retsrictions #
    binding_restrict=None

    # Get radius to calculate contacts #
    radii={options.pdb_chain:float(config.get("Parameters", "max_contact_distance"))}
    ...
    scores, binding_site = pwm.get_scores_and_binding_site(triads_obj, x3dna_obj, potentials, radii, fragment_restrict, binding_restrict, "s3dc_dd", options.pdb_chain)
