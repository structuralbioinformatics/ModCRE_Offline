...
class Experiment(object):
    ...
    def include_options(self, templates=None, models=None,  monomers=None, dimers=None,   thresholdPval=None, uniprotSearch=None, specie=None, family=None, fimo_threshold=None, time=None, job_name=None, input_pwm=None, default_pwm_db=None, jaspar_pwm_db=None, cisbp_pwm_db=None, output_type=None, cofactors=None,  all_orthologs=None, dna_seq=None, dna_str=None,  individual_models=None, combined_models=None, edges2model=None):
        # protein2DNA options #
        ...
        if all_orthologs is not None:self.__dict__["all_orthologs"]= all_orthologs
        # Queue options #
