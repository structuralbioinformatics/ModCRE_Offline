...
def cluster_motifs(motif_list):
    ...
    final_clusters = []
    for domain in list(clusters_dict.keys()):
...
def equal_binding_site(motif_groups):
    ...
    for group in motif_groups:
        ...
        for motif in group:
            ...
            if not bs_length in list(current_groups.keys()):
                current_groups[bs_length] = [motif]
            else:
                current_groups[bs_length].append(motif)
        for bs_length in list(current_groups.keys()):
